...
import image from './images/machines/Machine 3.png'
    ...
    <div className='product'>
        <div className='container'>
            <label className='longMachine'>
              <img src={image} alt='m3' />
            </label>
            <div className='specs'>
                <h2>{t('Automatic Grater Blocks')}</h2>
                <p>{t('Automatic Grater Machine is used for shredding blocks of Mozzarella, Romi, and Cheddar cheese.')}</p>
